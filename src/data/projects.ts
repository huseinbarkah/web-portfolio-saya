...
export const projects: Project[] = [
  {
    ...
    description: 'A modern landing page for a local kebab business in West Lombok, designed to increase online visibility and drive customer engagement.',
    ...
    longDescription: 'Kebab Pak Ewok is a beloved local food business in West Lombok. I designed and developed a clean, appetizing landing page that showcases their menu, location, and story — helping them reach more customers through digital presence.',
    longDescriptionId: 'Kebab Pak Ewok itu salah satu jajanan favorit di West Lombok. Saya bantuin bikin landing page yang simpel tapi bikin ngiler, nampilin menu, lokasi, dan ceritanya. Tujuannya simpel: biar pelanggannya nambah lewat internet.',
